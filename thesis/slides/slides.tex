...
\begin{columns}
	\begin{column}{0.6 \textwidth}
		\begin{figure}
			\includegraphics[ height=7.2cm]{gauss4d_final.png}
		\end{figure}
	\end{column}
	\begin{column}{0.4 \textwidth}
		\vspace{1cm} 
...
\begin{columns}
	\begin{column}{0.6 \textwidth}
		\begin{figure}
			\includegraphics[ height=7.2cm]{gauss8d_final.png}
		\end{figure}
	\end{column}
	\begin{column}{0.4 \textwidth}
		\vspace{1cm} 
...
\begin{columns}
	\begin{column}{0.6 \textwidth}
		\begin{figure}
			\includegraphics[ height=7.2cm]{gauss12d_final.png}
		\end{figure}
	\end{column}
	\begin{column}{0.4 \textwidth}
		\vspace{1cm} 
...
%\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.6 \textwidth}
			\begin{figure}
				\includegraphics[ height = 7.2 cm]{pineappl_final.png}
...
\begin{frame}{Single Top Production at LO - partonic level}
	...
	\begin{columns}
		\begin{column}{0.6 \textwidth}
			\begin{figure}
				\includegraphics[ height = 7.2 cm]{singletop_final.png}
			\end{figure}
		\end{column}
		\begin{column}{0.4 \textwidth}
			\vspace{1cm} 
...
\begin{frame}{Vector Boson Fusion Higgs production at LO}
	...
	\begin{columns}
		\begin{column}{0.6 \textwidth}
			\begin{figure}
				\includegraphics[ height=7.2cm]{higgs_final.png}
			\end{figure}
		\end{column}
		\begin{column}{0.4 \textwidth}
			\vspace{1cm} 
...
\textbf{Result benchmark}:
	...
	\begin{itemize}
		...
		\item classic VEGAS, as a  variation of VEGAS+, is the most efficient integrator
